(function(){zk._p=zkpi('zul.lang',true);try{msgzk={};msgzk.NOT_FOUND="No s'ha trobat: ";msgzk.UNSUPPORTED="Encara no és compatible: ";msgzk.FAILED_TO_SEND="Ha fallat l'enviament de la petició al servidor.";msgzk.FAILED_TO_RESPONSE="El servidor ha fallat en processar la petició.";msgzk.TRY_AGAIN="Voleu provar una altra vegada?";msgzk.UNSUPPORTED_BROWSER="El navegador no és compatible: ";msgzk.ILLEGAL_RESPONSE="Resposta desconeguda enviada des del servidor. Si us plau, recarregueu i proveu una altra vegada.\n";msgzk.FAILED_TO_PROCESS="Ha fallat el procés ";msgzk.GOTO_ERROR_FIELD="Aneu al camp erroni";msgzk.PLEASE_WAIT="S'està processant...";msgzk.FILE_SIZE="Mida de l'arxiu: ";msgzk.KBYTES="KB";msgzk.FAILED_TO_LOAD="Ha fallat la càrrega ";msgzk.FAILED_TO_LOAD_DETAIL="Pot haver estat provocat pel mal trànsit de les comunicacions. Podríeu recarregar aquesta pàgina i provar una altra vegada.";msgzk.CAUSE="Motiu: ";msgzk.LOADING="S'està processant";
zk.GROUPING=".";
zk.DECIMAL=",";
zk.PERCENT="%";
zk.MINUS="-";
