(function(){zk._p=zkpi('zul.lang',true);try{msgzk={};msgzk.NOT_FOUND="Nem található: ";msgzk.UNSUPPORTED="Még nem támogatott: ";msgzk.FAILED_TO_SEND="A szerver kérelem nem sikerült.";msgzk.FAILED_TO_RESPONSE="A webkiszolgáló ideiglenesen nem szolgál.";msgzk.TRY_AGAIN="Try again?";msgzk.UNSUPPORTED_BROWSER="Nem támogatott böngésző: ";msgzk.ILLEGAL_RESPONSE="Ismeretlen szerver válasz. Legyen szíves az oldalt újra letölteni.\n";msgzk.FAILED_TO_PROCESS="Nem sikerült feldolgozni ";msgzk.GOTO_ERROR_FIELD="Menyen a hibás bejegyzéshez";msgzk.PLEASE_WAIT="Feldolgozás...";msgzk.FILE_SIZE="Fajl mérete: ";msgzk.KBYTES="KB";msgzk.FAILED_TO_LOAD="Betöltés nem sikerült ";msgzk.FAILED_TO_LOAD_DETAIL="Rosz kapcsolat okozhatta. Próbáljan újra letölteni az oldalt.";msgzk.CAUSE="Hibát okozta: ";msgzk.LOADING="Feldolgozás";
zk.GROUPING=" ";
zk.DECIMAL=",";
zk.PERCENT="%";
zk.MINUS="-";
