(function(){zk._p=zkpi('zul.lang',true);try{msgzk={NOT_FOUND:"找不到：",UNSUPPORTED:"尚未支援：",FAILED_TO_SEND:"無法傳送資料到伺服器。",FAILED_TO_RESPONSE:"伺服器暫時無法處理你的請求。",TRY_AGAIN:"再試一次?",UNSUPPORTED_BROWSER:"尚未支援你使用的瀏覽器：",ILLEGAL_RESPONSE:"無法辨識伺服器傳回的資料。請按重新載入，再試試。\n",FAILED_TO_PROCESS:"無法處理：",GOTO_ERROR_FIELD:"回錯誤欄",PLEASE_WAIT:"處理中…",FILE_SIZE:"檔案大小：",KBYTES:"KB",FAILED_TO_LOAD:"無法載入：",FAILED_TO_LOAD_DETAIL:"可能是連線問題，請按重載再試一次。",CAUSE:"原因：",LOADING:"載入中"};
zk.GROUPING=",";
zk.DECIMAL=".";
zk.PERCENT="%";
zk.MINUS="-";
