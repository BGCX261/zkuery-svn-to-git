(function(){zk._p=zkpi('zul.lang',true);try{msgzk={};msgzk.NOT_FOUND="Nu s-a găsit: ";msgzk.UNSUPPORTED="Nu este suportat încă: ";msgzk.FAILED_TO_SEND="Procesul de trimitere a cererii către server a eşuat";msgzk.FAILED_TO_RESPONSE="Server-ul nu a putut procesa cererea dumneavoastră.";msgzk.TRY_AGAIN="Try again?";msgzk.UNSUPPORTED_BROWSER="Browser nu este suportat: ";msgzk.ILLEGAL_RESPONSE="Răspuns necunoscut trimis de server. Vă rugăm reîncărcaţi şi încercaţi din nou.\n";msgzk.FAILED_TO_PROCESS="Procesare eşuată ";msgzk.GOTO_ERROR_FIELD="Selectaţi câmpul greşit";msgzk.PLEASE_WAIT="Se procesează...";msgzk.FILE_SIZE="Dimensiune fişier: ";msgzk.KBYTES="KB";msgzk.FAILED_TO_LOAD="Eşuare la încărcare ";msgzk.FAILED_TO_LOAD_DETAIL="Poate fi cauzat de traficul anevoios. Puteţi reîncărca această pagină şi încerca din nou.";msgzk.CAUSE="Cauza: ";msgzk.LOADING="Se procesează";
zk.GROUPING=".";
zk.DECIMAL=",";
zk.PERCENT="%";
zk.MINUS="-";
...
zk.ERA="î.d.C.";
zk.YDELTA=0;
zk.SDOW=['L','Ma','Mi','J','V','S','D'];
zk.S2DOW=zk.SDOW;
zk.FDOW=['luni','marţi','miercuri','joi','vineri','sâmbătă','duminică'];
