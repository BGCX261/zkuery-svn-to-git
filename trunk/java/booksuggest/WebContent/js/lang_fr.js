(function(){zk._p=zkpi('zul.lang',true);try{msgzk={NOT_FOUND:"Pas trouvé: ",UNSUPPORTED:"Pas encore supporté: ",FAILED_TO_SEND:"Echec lors de l'envoi d'une requête vers le serveur.",FAILED_TO_RESPONSE:"Le serveur à échoué dans le traitement de votre requête.",TRY_AGAIN:"Voulez-vous essayer à nouveau?",UNSUPPORTED_BROWSER:"Navigateur non supporté: ",ILLEGAL_RESPONSE:"Réponse inconnue envoyée depuis le serveur. Rechagez cette page et essayez de nouveau.\n",FAILED_TO_PROCESS:"N'a pas été traité ",GOTO_ERROR_FIELD:"Allez sur le mauvais champ",PLEASE_WAIT:"Chargement...",FILE_SIZE:"Taille du fichier: ",KBYTES:"KB",FAILED_TO_LOAD:"Erreur de chargement ",FAILED_TO_LOAD_DETAIL:"Cela peut être dû à un problème de réseau. Rechagez cette page et essayez de nouveau.",CAUSE:"Cause: ",LOADING:"Chargement"};
zk.GROUPING=" ";
zk.DECIMAL=",";
zk.PERCENT="%";
zk.MINUS="-";
