(function(){zk._p=zkpi('zul.lang',true);try{msgzk={};msgzk.NOT_FOUND="Nenalezeno: ";msgzk.UNSUPPORTED="Nepodporováno: ";msgzk.FAILED_TO_SEND="Chyba při komunikaci se serverem.";msgzk.FAILED_TO_RESPONSE="Server je dočasně nedostupný, prosím opakujte akci později.";msgzk.TRY_AGAIN="Try again?";msgzk.UNSUPPORTED_BROWSER="Váš prohlížeč není podporován: ";msgzk.ILLEGAL_RESPONSE="Neznámá odpověď od serveru, opakujte prosím akci.\n";msgzk.FAILED_TO_PROCESS="Chyba zpracování ";msgzk.GOTO_ERROR_FIELD="Jdi na pole s chybou";msgzk.PLEASE_WAIT="Pracuji...";msgzk.FILE_SIZE="Velikost souboru: ";msgzk.KBYTES="KB";msgzk.FAILED_TO_LOAD="Chyba při nahrávání ";msgzk.FAILED_TO_LOAD_DETAIL="Chyba může být způsobena špatným připojením, zkuste obnovit stránku";msgzk.CAUSE="Příčina: ";msgzk.LOADING="Pracuji";
zk.GROUPING=" ";
zk.DECIMAL=",";
zk.PERCENT="%";
zk.MINUS="-";
