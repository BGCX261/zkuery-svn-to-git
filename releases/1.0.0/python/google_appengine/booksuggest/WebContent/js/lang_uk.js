(function(){zk._p=zkpi('zul.lang',true);try{msgzk={};msgzk.NOT_FOUND="Не знайдений: ";msgzk.UNSUPPORTED="Не підтримується: ";msgzk.FAILED_TO_SEND="Не вдалося відіслати запит на сервер.";msgzk.FAILED_TO_RESPONSE="Сервер тимчасово недоступний.";msgzk.TRY_AGAIN="Try again?";msgzk.UNSUPPORTED_BROWSER="Браузер не підтримується: ";msgzk.ILLEGAL_RESPONSE="Невідома відповідь з серверу. Будьласка, перевантажте сторінку і спробуйте знову.\n";msgzk.FAILED_TO_PROCESS="Не вдалося обробити ";msgzk.GOTO_ERROR_FIELD="Перехід до невірного поля";msgzk.PLEASE_WAIT="Обробка запиту...";msgzk.FILE_SIZE="Розмір файлу: ";msgzk.KBYTES="KB";msgzk.FAILED_TO_LOAD="Не вдалося завантажити ";msgzk.FAILED_TO_LOAD_DETAIL="Може бути спричинено проблемами з підключенням до мережі. Перевантажте сторінку і спробуйте знову.";msgzk.CAUSE="Причина: ";msgzk.LOADING="Обробка запиту";
zk.GROUPING=".";
zk.DECIMAL=",";
zk.PERCENT="%";
zk.MINUS="-";
