(function(){zk._p=zkpi('zul.lang',true);try{msgzk={};msgzk.NOT_FOUND="Niet gevonden: ";msgzk.UNSUPPORTED="Nog niet ondersteund: ";msgzk.FAILED_TO_SEND="Verzoek kan niet aan de server gestuurd worden.";msgzk.FAILED_TO_RESPONSE="Server kan verzoek niet verwerken.";msgzk.TRY_AGAIN="Try again?";msgzk.UNSUPPORTED_BROWSER="Niet ondersteunde Browser: ";msgzk.ILLEGAL_RESPONSE="Unbekend Antwoord van de Server, Aktualiseer aub de pagina en probeer opnieuw.\n";msgzk.FAILED_TO_PROCESS="Verwerking is fout gegaan ";msgzk.GOTO_ERROR_FIELD="Ga naar foutief veld";msgzk.PLEASE_WAIT="Verwerken...";msgzk.FILE_SIZE="Bestandsgrootte: ";msgzk.KBYTES="Kb";msgzk.FAILED_TO_LOAD="Het laden is mislukt ";msgzk.FAILED_TO_LOAD_DETAIL="Het kan veroorzaakt zijn door foutief verkeer. U kunt de pagina opnieuw landen en opnieuw proberen.";msgzk.CAUSE="Oorzaak: ";msgzk.LOADING="Verwerken";
zk.GROUPING=".";
zk.DECIMAL=",";
zk.PERCENT="%";
zk.MINUS="-";
