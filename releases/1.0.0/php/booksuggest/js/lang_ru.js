(function(){zk._p=zkpi('zul.lang',true);try{msgzk={};msgzk.NOT_FOUND="Не найден: ";msgzk.UNSUPPORTED="Не поддерживается: ";msgzk.FAILED_TO_SEND="Не удалось послать запрос на сервер.";msgzk.FAILED_TO_RESPONSE="Сервер временно недоступен.";msgzk.TRY_AGAIN="Попробуйте снова?";msgzk.UNSUPPORTED_BROWSER="Неподдерживаемый браузер: ";msgzk.ILLEGAL_RESPONSE="Неизвестный ответ получен от сервера. Пожалуйста перезагрузите страницу и попробуйте вновь.\n";msgzk.FAILED_TO_PROCESS="Не удалось обработать ";msgzk.GOTO_ERROR_FIELD="Перемещение к неверному полю";msgzk.PLEASE_WAIT="Обработка запроса...";msgzk.FILE_SIZE="Размер файла: ";msgzk.KBYTES="KB";msgzk.FAILED_TO_LOAD="Не удалось загрузить ";msgzk.FAILED_TO_LOAD_DETAIL="Возможно, проблема с подключением к сети. Перезагрузите страницу и попробуйте снова.";msgzk.CAUSE="Причина: ";msgzk.LOADING="Обработка запроса";
zk.GROUPING=" ";
zk.DECIMAL=",";
zk.PERCENT="%";
zk.MINUS="-";
